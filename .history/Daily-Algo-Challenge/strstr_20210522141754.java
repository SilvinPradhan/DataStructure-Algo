 ...
 */
  ...
  * Scenarios to be considered
    i.  needle or haystack is empty. If needle is empty, always return 0. If haystack is empty, then there will always be no match(return -1) unless the needle is also empty
  */
